...
const NotificationBar = () => {
  return (
    <div class="relative w-full w-screen flex flex-col flex items-center">
      ...
      <div class="left-20 z-20 m-5 overflow-hidden bg-white rounded-md shadow-lg w-50 dark:bg-gray-800">
        <div class="py-2">
          <a
            href="#"
